function validaCPF(cpf:string):any{
    //preparando os números inseridos
    const arrayCPF = cpf.split("-")
    const splitDV = arrayCPF[1].split("")
    // console.log("digitos inseridos", splitDV);
    const d1Inserido = Number(splitDV[0])
    const d2Inserido = Number(splitDV[1])

    
    // console.log("código base e digitos verificadores", arrayCPF);
    ...
    // console.log("moduloSoma", moduloSoma);
    const digitoVerificador1 = 11 - moduloSoma
    // console.log("DV1",digitoVerificador1);
    ...
    //  console.log("moduloSoma2", moduloSoma2);
     const digitoVerificador2 = 11 - moduloSoma2
    //  console.log("DV2", digitoVerificador2);
